...
/* Definitions for audioTaskHandle */
...
osMessageQueueId_t queue_gpioHandle;
...
int main(void)
{
  ...
  /* Create the queue(s) */
  /* creation of queue_gpio */
  queue_gpioHandle = osMessageQueueNew (1, sizeof(uint16_t), &queue_gpio_attributes);
...
* @retval None
*/
/* USER CODE END Header_audioTaskHandler */
void audioTaskHandler(void *argument)
{
