...
/* SAI2 */
  ...
  */
    ...
    PeriphClkInit.Sai2ClockSelection = RCC_SAI2CLKSOURCE_PLL2P;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    PE7     ------> SAI2_SD_B
    */
    GPIO_InitStruct.Pin = GPIO_PIN_13|GPIO_PIN_12|GPIO_PIN_7;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    handle_GPDMA1_Channel15.Init.Request = GPDMA1_REQUEST_SAI2_B;
    ...
    __HAL_LINKDMA(hsai, hdmatx, handle_GPDMA1_Channel15);
...
/* SAI2 */
    ...
    PE7     ------> SAI2_SD_B
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_13|GPIO_PIN_12|GPIO_PIN_7);
